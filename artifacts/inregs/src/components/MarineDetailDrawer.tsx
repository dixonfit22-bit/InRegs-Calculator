...
import { CheckCircle2, Zap, XCircle, TrendingDown, TrendingUp, Minus, Pencil, Trash2 } from "lucide-react";
          ...
          <>
            ...
            <DrawerHeader className="text-left pb-2 shrink-0">
              ...
              <div className="flex items-center gap-3 mt-1 flex-wrap">
                <p className="text-[10px] text-muted-foreground">Recorded {fmtDate(profile.updatedAt)}</p>
            ...
            <div className="flex-1 overflow-y-auto px-4 pb-2 flex flex-col gap-5">
              ...
              <div>
                ...
                <FieldRow label="BF Buffer"    value={
